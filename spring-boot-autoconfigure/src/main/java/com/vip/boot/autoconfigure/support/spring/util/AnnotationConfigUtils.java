package com.vip.boot.autoconfigure.support.spring.util;
...
public class AnnotationConfigUtils {
    ...
    private static final ClassLoader classLoader = org.springframework.context.annotation.AnnotationConfigUtils.class.getClassLoader();
    ...
    @UtilityClass
    public static class ScopedProxyCreator {
